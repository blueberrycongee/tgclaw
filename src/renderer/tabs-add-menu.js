...
const deps = { addAgentTab: async () => null };
...
export function configureTabsAddMenu(nextDeps) { Object.assign(deps, nextDeps); }
...
export function initAgentPicker() {
  ...
  if (addTabButton && addTabHoverMenu && addTabDefaultAnchor && addTabDefaultSubmenu) {
    ...
    addTabButton.addEventListener('click', (event) => {
      ...
      hideAddTabHoverMenu();
      void deps.addAgentTab(addTabDefaultAgent);
    });
